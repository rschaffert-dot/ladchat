...
const styles = StyleSheet.create({
  ...
  manageBtn: { borderRadius: 0, paddingVertical: 14, alignItems: "center", marginBottom: 8 },
  ...
  card: { borderRadius: 0, padding: 16, marginTop: 12 },
  cardHeader: { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 6 },
  cardTitle: { flex: 1, fontSize: 16, fontWeight: "800" },
  badge: { borderWidth: 1, borderRadius: 0, paddingHorizontal: 10, paddingVertical: 3 },
