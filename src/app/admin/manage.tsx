...
const styles = StyleSheet.create({
  ...
  rowInput: { flex: 1 },
  primaryBtn: { borderRadius: 0, paddingVertical: 13, alignItems: "center", marginBottom: 8 },
  primaryBtnText: { color: "#fff", fontWeight: "700" },
  tournamentCard: { borderRadius: 0, padding: 16, marginTop: 20 },
  tournamentHeader: { flexDirection: "row", alignItems: "center", gap: 8 },
  tournamentTitle: { flex: 1, fontSize: 17, fontWeight: "800" },
  deleteBtn: { borderWidth: 1, borderRadius: 0, paddingHorizontal: 12, paddingVertical: 6 },
  ...
  smallBtn: { borderRadius: 0, paddingHorizontal: 12, paddingVertical: 8 },
