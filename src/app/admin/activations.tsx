...
const styles = StyleSheet.create({
  ...
  kindChip: { borderWidth: 1, borderRadius: 0, paddingHorizontal: 12, paddingVertical: 8 },
  ...
  addBtn: { borderRadius: 0, paddingVertical: 14, alignItems: "center", marginTop: 16 },
  addBtnText: { color: "#fff", fontWeight: "700" },
  card: { borderRadius: 0, padding: 16, marginTop: 12, gap: 8 },
